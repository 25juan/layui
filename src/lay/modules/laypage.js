...
layui.define(function(exports){
  ...
  Class.prototype.view = function(){
    ...
    config.prev = 'prev' in config ? config.prev : layui.i18n('laypage.prev'); //上一页文本
    config.next = 'next' in config ? config.next : layui.i18n('laypage.next'); //下一页文本
    ...
    ,views = {
      ...
      ,page: function(){
        ...
        if(index > 1 && config.first !== false && groups !== 0){
          pager.push('<a href="javascript:;" class="layui-laypage-first" data-page="1"  title="'+layui.i18n('laypage.home')+'">'+ (config.first || 1) +'</a>');
        }
        ...
        if(config.first !== false && start > 2){
          pager.push('<span class="layui-laypage-spr">'+layui.i18n('laypage.more')+'</span>')
        }
        ...
        if(config.pages > groups && config.pages > end && config.last !== false){
          ...
          if(groups !== 0){
            pager.push('<a href="javascript:;" class="layui-laypage-last" title="'+layui.i18n('laypage.end')+'"  data-page="'+ config.pages +'">'+ (config.last || config.pages || layui.i18n('laypage.end') ) +'</a>');
          }
        }
      ...
      ,count: (function () {
          var list =[
            ...
            '<span class="layui-laypage-page"> <span class="layui-laypage-text">'+layui.i18n('laypage.curr.page')+"</span><span class='layui-laypage-curr-page'>"+ config.curr + '</span> <span class="layui-laypage-split">/</span> <span class="layui-laypage-total">' +config.pages +'</span></span>'
          ]
          return list.join("");
        })()
      //每页条数
      ,limit: function(){
        ...
        layui.each(config.limits, function(index, item){
          options.push(
            ...
            +'>'+ item + layui.i18n('laypage.per') +' </option>'
          );
        });
      ...
      //跳页区域
      ,skip: function(){
        return ['<span class="layui-laypage-skip">'+ layui.i18n("laypage.jumpText"),'<input type="text" min="1" value="'+ config.curr +'" class="layui-input">'
